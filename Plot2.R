...
NDate <- paste(data$Date, data$Time)
NDate <- strptime(NDate, format = "%Y-%m-%d %H:%M:%S")
...
with(data1, plot(data1$NDate,Global_active_power, xlab="",ylab="Global Active Power(kilowatts)",type = "l"))
