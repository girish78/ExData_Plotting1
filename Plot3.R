...
with(data1, plot(data1$NDate,Sub_metering_1, xlab="",ylab="Energy Sub Metering",type = "l"))
####lines(data1$NDate,data$Sub_metering_1,type = "l",lty = 1)
lines(data1$NDate,data1$Sub_metering_2,type = "l",lty = 1,col="red")
lines(data1$NDate,data1$Sub_metering_3,type = "l",lty = 1,col="blue")
####Create Legend on the Top Right corner with appropriate line colors & appropriate Legend Text####
